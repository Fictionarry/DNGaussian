...
from gaussian_renderer_sh import render, render_for_depth   # , network_gui
import sys
from scene_sh import Scene, GaussianModel
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        # opa_pena = 1 - (opacity[opacity > 0.6]**2).mean() + ((1 - opacity[opacity < 0.6])**2).mean()
